def hjemmeHosHende():
    sex = 0
    hvadnu = input("""Du klarede det, du charmerede dig ind på damen
          og har fået lov til at komme hjem til hende. 
    ...
    if (hvadnu == "2"):
        print("""Du gå ud til pigen på hendes soveværelse, det er relativt lille men der er plads til to i sengen. 
    ...
    if (hvadnu == "3"):
        ...
        if (lorteloesning == "2"):
            print("""Du valgte at lade lorten ligge. Et valg som kune en kryster ville tage. 
                  Det viser sig at hun også skal på toilettet bagefter, 
                  og du bliver smidt hjem af en fuld pige der synes dit lort er klamt.""")
        if (lorteloesning == "3"):
