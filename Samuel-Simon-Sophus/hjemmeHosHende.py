def hjemmeHosHende():
    sex = 0
    hvadnu = input("""
    Du klarede det, du charmerede dig ind på damen og har fået lov til at komme hjem til hende. 
    Men du er ikke færdig endnu, du vil helst godt i seng med hende og måske få en date mere.
    ...
    if (hvadnu == "1"):
        print("""
        Du valgte at gå ud i køkkenet, hvor du æder alt hendes mad og bliver smidt ud. Dårlig stil...
        """)

    if (hvadnu == "2"):
        print("""
        Du går ud til pigen på hendes soveværelse, det er relativt lille men der er plads til to i sengen. 
    ...
    if (hvadnu == "3"):
        lorteloesning = input("""
        Du går ud på toilettet fordi du skal skide, du sætter dig på kummen og laver en stor lort. 
        ...
        if (lorteloesning == "1"):
            print("""
            Du smed lorten ud af vinduet. Den perfekte løsning. 
        ...
        if (lorteloesning == "2"):
            print("""
            Du valgte at lade lorten ligge. Et valg som kune en kryster ville tage. 
            Det viser sig at hun også skal på toilettet bagefter, og du bliver smidt hjem af en fuld pige der synes dit lort er klamt.""")

        if (lorteloesning == "3"):
            print("""
            Du prøver at fikse toilettet, du har jo fikset ting før.
